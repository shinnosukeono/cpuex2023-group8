...
HD_PWD='C:/Projects/core_v2/core_v2.runs/design_1_cache_v_7_0_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cache_v_7_0_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cache_v_7_0_0_0.tcl
