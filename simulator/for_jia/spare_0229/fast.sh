...
cp ./inputs/main_init.s ./pre_assemble/in.s
printf "\n" >> ./pre_assemble/in.s
cat ./inputs/main.s >> ./pre_assemble/in.s
printf "\n" >> ./pre_assemble/in.s
cat ./inputs/main_lib.s >> ./pre_assemble/in.s
printf "\n" >> ./pre_assemble/in.s
cd pre_assemble
./a.out
cp out.s ../assemble/a.s
cd ../assemble
...
cd ../simulator
cat fast_mode.txt ../inputs/contest.sld | ./main
