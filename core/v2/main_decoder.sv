...
// Out:       9
    ...
    always_comb begin
        case (opecode)
            ...
            7'b0010100: controls = 22'b0_000_1000_00_xxx_x_0_1_0_0_0111;  // cin_int
            7'b0010001: controls = 22'b0_000_1001_00_xxx_x_0_0_0_0_0000;  // out
            ...
            7'b0110111: controls = 22'b0_000_0000_00_101_x_0_1_0_0_0100;  // lui, don't care alu_src, alu_op
            ...
            // RVF
            7'b1000011: controls = 22'b0_111_0111_00_xxx_x_0_0_1_0_1110;  // fmadd
            7'b1000111: controls = 22'b0_111_0111_00_xxx_x_0_0_1_0_1110;  // fmsub
            7'b1001011: controls = 22'b0_111_0111_00_xxx_x_0_0_1_0_1110;  // fnmsub
            7'b1001111: controls = 22'b0_111_0111_00_xxx_x_0_0_1_0_1110;  // fnmadd
            7'b1010011: begin
                casez (funct7_2_6)
                    5'b0000?: controls = 22'b0_110_0110_00_xxx_x_0_0_1_0_0110;  // fadd, fsub
                    5'b00010: controls = 22'b0_110_0110_00_xxx_x_0_0_1_0_0110;  // fmul
                    5'b00011: controls = 22'b0_110_0111_00_xxx_x_0_0_1_0_1110;  // fdiv
                    5'b01011: controls = 22'b0_100_0111_00_xxx_x_0_0_1_0_1110;  // fsqrt
                    5'b00100: controls = 22'b0_110_0110_00_xxx_x_0_0_1_0_0110;  // fsgnj, fsgnjn, fsgnjx
                    5'b00101: controls = 22'b0_110_0110_00_xxx_x_0_0_1_0_0110;  // fmin, fmax
                    5'b10100: controls = 22'b0_110_0110_00_xxx_x_0_1_0_0_0110;  // feq, flt, fle
                    5'b11100: begin
                        case (funct3)
                            3'b001: controls = 22'b0_100_0110_00_xxx_x_0_1_0_0_0110;  // fclass
                            3'b000: controls = 22'b0_100_0000_00_xxx_x_0_1_0_0_0101;  // fmv.x.w
                            default: controls = 22'b0_000_0000_00_xxx_x_0_0_0_0_0000;  // error
                        endcase
                    end
                    ...
                    5'b11000: controls = 22'b0_100_0110_00_xxx_x_0_1_0_0_0110;  // fcvt.w.s, fcvt.wu.s
                    5'b11010: controls = 22'b0_000_0110_00_xxx_x_0_0_1_0_0110;  // fcvt.s.w, fcvt.s.wu
                    5'b11110: controls = 22'b0_000_0000_00_xxx_x_0_0_1_0_0011;  // fmv.w.x
                    default: controls = 22'b0_000_0000_00_xxx_x_0_0_0_0_0000;  // error
                endcase
            end
            7'b1010100: controls = 22'b0_000_1000_00_xxx_x_0_0_1_0_0111;  // cin_float
            7'b0000111: controls = 22'b0_000_0100_00_000_x_0_0_1_0_0001;  // flw
            7'b0100111: controls = 22'b0_010_0101_00_001_x_1_0_0_0_0000;  // fsw
            default: controls = 22'b0_000_0000_00_xxx_x_0_0_0_0_0000;  // error
        endcase
    end
endmodule