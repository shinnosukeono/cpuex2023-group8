...
B771:
    ...
    fmv.s fs1, fa3
    mv s2, a0
B132:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B771, B685
    li t0, 5
    blt s2, t0, B685
    j B684
...
B773:
    ...
    mv s1, a1
    mv s2, a2
B134:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B773, B688
    blt s0, zero, B689
...
B772:
    ...
    mv s1, a0
    mv s2, a1
B133:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B772, B686
    blt s1, zero, B687
...
B723:
    ...
    fmv.s fs2, fa2
    mv s1, a0
B86:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B723, B362
    slli t0, s1, 2
    add t0, s0, t0
    lw t0, 0(t0)
    li t1, -1
...
B774:
    mv s0, a0
    mv s1, a1
B136:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B774, B690
    blt s1, zero, B691
...
B775:
    mv s0, a0
B137:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B775, B696
    blt s0, zero, B693
...
B696:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B694, B776
    addi t0, s0, -1
    mv s0, t0
    j B137
B776:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B692
    j B696
B693:  #  pred: B137
    lw s0, 24(sp)
    lw s1, 20(sp)
...
B112:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B761, B579
    li t0, 4
    blt t0, s8, B574
...
B579:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B577, B762
    addi t0, s8, 1
    mv s8, t0
    j B112
B762:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B575
    j B579
B576:  #  pred: B573
    lw s0, 36(sp)
    lw s1, 32(sp)
...
B777:
    mv s0, a0
    mv s1, a1
B138:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B777, B697
    blt s1, zero, B698
...
B770:
    mv s0, a0
    mv s1, a1
B128:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B770, B680
    blt s1, zero, B681
...
B778:
    mv s0, a0
B139:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B778, B703
    blt s0, zero, B700
...
B703:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B701, B779
    addi t0, s0, -1
    mv s0, t0
    j B139
B779:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B699
    j B703
B700:  #  pred: B139
    lw s0, 8(sp)
    lw s1, 4(sp)
...
B720:
    ...
    mv s1, a1
    mv s2, a2
B78:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B720, B329
    blt s2, zero, B323
...
B751:
    ...
    mv s1, a1
    mv s2, a3
B107:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B751, B543
    blt s2, zero, B540
...
B121:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B765, B661
    li t0, 4
    blt t0, s6, B656
...
B659:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B657
    ...
    flw ft0, 8(s7)
    fsw ft0, 8(t0)
B661:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B659, B766
    addi t0, s6, 1
    mv s6, t0
    j B121
B766:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B657
    j B661
B658:  #  pred: B655
    lw s0, 52(sp)
    lw s1, 48(sp)
...
B767:
    ...
    mv s1, a1
    mv s2, a2
B122:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B767, B669
    blt s1, zero, B663
...
B718:
    mv s0, a0
B59:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B718, B202
    li a0, 0
    call read_net_item
    lw t0, 0(a0)
    li t1, -1
...
B717:
    mv s0, a0
B55:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B717, B195
    li t0, 60
    bge s0, t0, B194
...
B768:
    ...
    mv s4, a5
    mv s5, a0
B124:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B768, B674
    lui t1, %hi(image_size)
    lw t0, %lo(image_size)(t1)
    lw t0, 0(t0)
    bge s5, t0, B671
...
B721:
    mv s0, a0
    mv s1, a1
B80:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B721, B340
    blt s1, zero, B331
...
B332:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B330
    ...
    fadd.s ft0, ft0, ft1
    fsw ft0, 12(s3)
B340:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B332, B338, B722
    addi t0, s1, -1
    mv s1, t0
    j B80
...
B337:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B334
    fmv.s ft0, fa0
    j B338
B722:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B333
    j B340
B331:  #  pred: B80
    lw s0, 24(sp)
    lw s1, 20(sp)
...
B724:
    mv s0, a1
    mv s1, a0
B87:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B724, B371, B372
    slli t0, s1, 2
    add t0, s0, t0
    lw t0, 0(t0)
    li t1, -1
...
B725:
    mv s0, a1
    mv s1, a0
B88:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B725, B377
    slli t0, s1, 2
    add t0, s0, t0
    lw t0, 0(t0)
    li t1, -1
...
B726:
    mv s0, a1
    mv s1, a0
B89:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B726, B393, B395
    slli t0, s1, 2
    add t0, s0, t0
    lw s2, 0(t0)
    lw t0, 0(s2)
...
B727:
    ...
    mv s1, a2
    mv s2, a0
B90:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B727, B408, B409
    slli t0, s2, 2
    add t0, s0, t0
    lw s3, 0(t0)
    li t0, -1
...
B404:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B402
    ...
    lw t0, %lo(intsec_rectside)(t1)
    sw s5, 0(t0)
B408:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B404, B730, B729, B728
    addi t0, s2, 1
    mv s2, t0
    j B90
B730:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B402
    j B408
B729:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B400
    j B408
B728:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B398
    j B408
...
B735:
    ...
    mv s2, a3
    mv s3, a0
B94:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B735, B438, B439
    slli t0, s3, 2
    add t0, s0, t0
    lw s4, 0(t0)
    li t0, -1
...
B434:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B432
    ...
    lw t0, %lo(intsec_rectside)(t1)
    sw s5, 0(t0)
B438:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B434, B738, B737, B736
    addi t0, s3, 1
    mv s3, t0
    j B94
B738:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B432
    j B438
B737:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B430
    j B438
B736:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B428
    j B438
...
B731:
    ...
    mv s1, a2
    mv s2, a0
B91:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B731, B411
    slli t0, s2, 2
    add t0, s0, t0
    lw t0, 0(t0)
    li t1, -1
...
B739:
    ...
    mv s2, a3
    mv s3, a0
B95:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B739, B441
    slli t0, s3, 2
    add t0, s0, t0
    lw t0, 0(t0)
    li t1, -1
...
B732:
    ...
    mv s1, a2
    mv s2, a0
B92:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B732, B423
    slli t0, s2, 2
    add t0, s0, t0
    lw s3, 0(t0)
    lw t0, 0(s3)
...
B423:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B415, B419, B734, B733
    addi t0, s2, 1
    mv s2, t0
    j B92
...
B419:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B417
    ...
    call solve_one_or_network
    j B423
B734:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B417
    j B423
B733:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B416
    j B423
B413:  #  pred: B92
    lw s0, 24(sp)
    lw s1, 20(sp)
...
B740:
    ...
    mv s2, a3
    mv s3, a0
B96:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B740, B453
    slli t0, s3, 2
    add t0, s0, t0
    lw s4, 0(t0)
    lw t0, 0(s4)
...
B453:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B445, B449, B742, B741
    addi t0, s3, 1
    mv s3, t0
    j B96
...
B449:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B447
    ...
    call solve_one_or_network_fast
    j B453
B742:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B447
    j B453
B741:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B446
    j B453
B443:  #  pred: B96
    lw s0, 24(sp)
    lw s1, 20(sp)
...
B105:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B748, B526
    li t0, 4
    blt t0, s5, B512
...
B518:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B517
    ...
    fmv.s fa2, fs3
    call add_light
B520:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B518, B749
    flw ft0, 0(s0)
    lui t1, %hi(startp_fast)
    lw t0, %lo(startp_fast)(t1)
    fsw ft0, 0(t0)
...
B523:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B521
    ...
    add t0, s2, t0
    sw t1, 0(t0)
B525:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B523, B750
    li t0, 2
    bne s10, t0, B527
B526:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B525
    ...
    j B105
B750:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B521
    j B525
B749:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B517
    j B520
...
B744:
    ...
    fmv.s fs1, fa1
    mv s1, a0
B104:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B744, B510
    blt s1, zero, B501
...
B506:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B504
    ...
    fmv.s fa2, fs1
    call add_light
B510:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B506, B747, B746, B745
    addi t0, s1, -1
    mv s1, t0
    j B104
B747:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B504
    j B510
B746:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B502
    j B510
B745:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B500
    j B510
B501:  #  pred: B104
    lw s0, 24(sp)
    lw s1, 20(sp)
...
B763:
    ...
    mv s3, a4
    mv s4, a5
B116:  # loop header, loop_depth: 1, loop_index: 0  #  pred: B763, B604
    slli t0, s0, 5
    add t0, s2, t0
    lw t1, 0(t0)
    lw t1, 4(t0)
...
B604:  # loop end, loop_depth: 1, loop_index: 0  #  pred: B602, B764
    addi t0, s4, 1
    mv s4, t0
    j B116
B764:  # loop body, loop_depth: 1, loop_index: 0  #  pred: B600
    j B604
B601:  #  pred: B598
    slli t0, s0, 5
    add t0, s2, t0
