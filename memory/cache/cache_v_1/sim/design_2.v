...
module design_2
  ...
  wire [26:0]cache_controller_wra_0_M_AXI_ARADDR;
  wire [1:0]cache_controller_wra_0_M_AXI_ARBURST;
  wire [3:0]cache_controller_wra_0_M_AXI_ARCACHE;
  wire [0:0]cache_controller_wra_0_M_AXI_ARID;
  wire [7:0]cache_controller_wra_0_M_AXI_ARLEN;
  wire cache_controller_wra_0_M_AXI_ARLOCK;
  wire [2:0]cache_controller_wra_0_M_AXI_ARPROT;
  wire [3:0]cache_controller_wra_0_M_AXI_ARQOS;
  wire cache_controller_wra_0_M_AXI_ARREADY;
  wire [2:0]cache_controller_wra_0_M_AXI_ARSIZE;
  wire [0:0]cache_controller_wra_0_M_AXI_ARUSER;
  wire cache_controller_wra_0_M_AXI_ARVALID;
  wire [26:0]cache_controller_wra_0_M_AXI_AWADDR;
  wire [1:0]cache_controller_wra_0_M_AXI_AWBURST;
  wire [3:0]cache_controller_wra_0_M_AXI_AWCACHE;
  wire [0:0]cache_controller_wra_0_M_AXI_AWID;
  wire [7:0]cache_controller_wra_0_M_AXI_AWLEN;
  wire cache_controller_wra_0_M_AXI_AWLOCK;
  wire [2:0]cache_controller_wra_0_M_AXI_AWPROT;
  wire [3:0]cache_controller_wra_0_M_AXI_AWQOS;
  wire cache_controller_wra_0_M_AXI_AWREADY;
  wire [2:0]cache_controller_wra_0_M_AXI_AWSIZE;
  wire [0:0]cache_controller_wra_0_M_AXI_AWUSER;
  wire cache_controller_wra_0_M_AXI_AWVALID;
  wire [0:0]cache_controller_wra_0_M_AXI_BID;
  wire cache_controller_wra_0_M_AXI_BREADY;
  wire [1:0]cache_controller_wra_0_M_AXI_BRESP;
  wire [0:0]cache_controller_wra_0_M_AXI_BUSER;
  wire cache_controller_wra_0_M_AXI_BVALID;
  wire [127:0]cache_controller_wra_0_M_AXI_RDATA;
  wire [0:0]cache_controller_wra_0_M_AXI_RID;
  wire cache_controller_wra_0_M_AXI_RLAST;
  wire cache_controller_wra_0_M_AXI_RREADY;
  wire [1:0]cache_controller_wra_0_M_AXI_RRESP;
  wire [0:0]cache_controller_wra_0_M_AXI_RUSER;
  wire cache_controller_wra_0_M_AXI_RVALID;
  wire [127:0]cache_controller_wra_0_M_AXI_WDATA;
  wire cache_controller_wra_0_M_AXI_WLAST;
  wire cache_controller_wra_0_M_AXI_WREADY;
  wire [15:0]cache_controller_wra_0_M_AXI_WSTRB;
  wire [0:0]cache_controller_wra_0_M_AXI_WUSER;
  wire cache_controller_wra_0_M_AXI_WVALID;
  wire cache_controller_wra_0_core_data_valid;
  wire [31:0]cache_controller_wra_0_core_dout;
  wire cache_controller_wra_0_io_data_valid;
  wire [31:0]cache_controller_wra_0_io_dout;
  wire cache_controller_wra_0_io_init_complete;
  wire clk_1;
  wire clk_wiz_0_clk_out200m;
  wire clk_wiz_0_clk_out333m;
  ...
  assign core_data_valid = cache_controller_wra_0_core_data_valid;
  assign core_din_1 = core_din[31:0];
  assign core_dout[31:0] = cache_controller_wra_0_core_dout;
  ...
  assign io_data_valid = cache_controller_wra_0_io_data_valid;
  assign io_din_1 = io_din[31:0];
  assign io_dout[31:0] = cache_controller_wra_0_io_dout;
  assign io_init_complete = cache_controller_wra_0_io_init_complete;
  ...
  design_2_c_shift_ram_0_0 c_shift_ram_0
       (.CE(xlslice_0_Dout),
        ...
        .D(xlconstant_0_dout),
        .Q(c_shift_ram_0_Q));
  design_2_cache_controller_wra_0_0 cache_controller_wra_0
       (.M_AXI_ARADDR(cache_controller_wra_0_M_AXI_ARADDR),
        .M_AXI_ARBURST(cache_controller_wra_0_M_AXI_ARBURST),
        .M_AXI_ARCACHE(cache_controller_wra_0_M_AXI_ARCACHE),
        .M_AXI_ARID(cache_controller_wra_0_M_AXI_ARID),
        .M_AXI_ARLEN(cache_controller_wra_0_M_AXI_ARLEN),
        .M_AXI_ARLOCK(cache_controller_wra_0_M_AXI_ARLOCK),
        .M_AXI_ARPROT(cache_controller_wra_0_M_AXI_ARPROT),
        .M_AXI_ARQOS(cache_controller_wra_0_M_AXI_ARQOS),
        .M_AXI_ARREADY(cache_controller_wra_0_M_AXI_ARREADY),
        .M_AXI_ARSIZE(cache_controller_wra_0_M_AXI_ARSIZE),
        .M_AXI_ARUSER(cache_controller_wra_0_M_AXI_ARUSER),
        .M_AXI_ARVALID(cache_controller_wra_0_M_AXI_ARVALID),
        .M_AXI_AWADDR(cache_controller_wra_0_M_AXI_AWADDR),
        .M_AXI_AWBURST(cache_controller_wra_0_M_AXI_AWBURST),
        .M_AXI_AWCACHE(cache_controller_wra_0_M_AXI_AWCACHE),
        .M_AXI_AWID(cache_controller_wra_0_M_AXI_AWID),
        .M_AXI_AWLEN(cache_controller_wra_0_M_AXI_AWLEN),
        .M_AXI_AWLOCK(cache_controller_wra_0_M_AXI_AWLOCK),
        .M_AXI_AWPROT(cache_controller_wra_0_M_AXI_AWPROT),
        .M_AXI_AWQOS(cache_controller_wra_0_M_AXI_AWQOS),
        .M_AXI_AWREADY(cache_controller_wra_0_M_AXI_AWREADY),
        .M_AXI_AWSIZE(cache_controller_wra_0_M_AXI_AWSIZE),
        .M_AXI_AWUSER(cache_controller_wra_0_M_AXI_AWUSER),
        .M_AXI_AWVALID(cache_controller_wra_0_M_AXI_AWVALID),
        .M_AXI_BID(cache_controller_wra_0_M_AXI_BID),
        .M_AXI_BREADY(cache_controller_wra_0_M_AXI_BREADY),
        .M_AXI_BRESP(cache_controller_wra_0_M_AXI_BRESP),
        .M_AXI_BUSER(cache_controller_wra_0_M_AXI_BUSER),
        .M_AXI_BVALID(cache_controller_wra_0_M_AXI_BVALID),
        .M_AXI_RDATA(cache_controller_wra_0_M_AXI_RDATA),
        .M_AXI_RID(cache_controller_wra_0_M_AXI_RID),
        .M_AXI_RLAST(cache_controller_wra_0_M_AXI_RLAST),
        .M_AXI_RREADY(cache_controller_wra_0_M_AXI_RREADY),
        .M_AXI_RRESP(cache_controller_wra_0_M_AXI_RRESP),
        .M_AXI_RUSER(cache_controller_wra_0_M_AXI_RUSER),
        .M_AXI_RVALID(cache_controller_wra_0_M_AXI_RVALID),
        .M_AXI_WDATA(cache_controller_wra_0_M_AXI_WDATA),
        .M_AXI_WLAST(cache_controller_wra_0_M_AXI_WLAST),
        .M_AXI_WREADY(cache_controller_wra_0_M_AXI_WREADY),
        .M_AXI_WSTRB(cache_controller_wra_0_M_AXI_WSTRB),
        .M_AXI_WUSER(cache_controller_wra_0_M_AXI_WUSER),
        .M_AXI_WVALID(cache_controller_wra_0_M_AXI_WVALID),
        .clk(clk_1),
        .core_addr(core_addr_1),
        .core_complete(core_complete_1),
        .core_data_valid(cache_controller_wra_0_core_data_valid),
        .core_din(core_din_1),
        .core_dout(cache_controller_wra_0_core_dout),
        .core_we(core_we_1),
        .io_addr(io_addr_1),
        .io_data_valid(cache_controller_wra_0_io_data_valid),
        .io_din(io_din_1),
        .io_dout(cache_controller_wra_0_io_dout),
        .io_init_complete(cache_controller_wra_0_io_init_complete),
        .io_we(io_we_1),
        .mig_init_complete(util_vector_logic_0_Res),
        .rstn(resetn_1));
  design_2_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(clk_1),
        .clk_out200m(clk_wiz_0_clk_out200m),
        .clk_out333m(clk_wiz_0_clk_out333m),
        .locked(clk_wiz_0_locked),
        .resetn(resetn_1));
  design_2_fifo_generator_0_0 fifo_generator_0
       (.m_aclk(mig_7series_0_ui_clk),
        ...
        .s_aclk(clk_1),
        .s_aresetn(c_shift_ram_0_Q),
        .s_axi_araddr(cache_controller_wra_0_M_AXI_ARADDR),
        .s_axi_arburst(cache_controller_wra_0_M_AXI_ARBURST),
        .s_axi_arcache(cache_controller_wra_0_M_AXI_ARCACHE),
        .s_axi_arid(cache_controller_wra_0_M_AXI_ARID),
        .s_axi_arlen(cache_controller_wra_0_M_AXI_ARLEN),
        .s_axi_arlock(cache_controller_wra_0_M_AXI_ARLOCK),
        .s_axi_arprot(cache_controller_wra_0_M_AXI_ARPROT),
        .s_axi_arqos(cache_controller_wra_0_M_AXI_ARQOS),
        .s_axi_arready(cache_controller_wra_0_M_AXI_ARREADY),
        .s_axi_arregion({1'b0,1'b0,1'b0,1'b0}),
        .s_axi_arsize(cache_controller_wra_0_M_AXI_ARSIZE),
        .s_axi_aruser(cache_controller_wra_0_M_AXI_ARUSER),
        .s_axi_arvalid(cache_controller_wra_0_M_AXI_ARVALID),
        .s_axi_awaddr(cache_controller_wra_0_M_AXI_AWADDR),
        .s_axi_awburst(cache_controller_wra_0_M_AXI_AWBURST),
        .s_axi_awcache(cache_controller_wra_0_M_AXI_AWCACHE),
        .s_axi_awid(cache_controller_wra_0_M_AXI_AWID),
        .s_axi_awlen(cache_controller_wra_0_M_AXI_AWLEN),
        .s_axi_awlock(cache_controller_wra_0_M_AXI_AWLOCK),
        .s_axi_awprot(cache_controller_wra_0_M_AXI_AWPROT),
        .s_axi_awqos(cache_controller_wra_0_M_AXI_AWQOS),
        .s_axi_awready(cache_controller_wra_0_M_AXI_AWREADY),
        .s_axi_awregion({1'b0,1'b0,1'b0,1'b0}),
        .s_axi_awsize(cache_controller_wra_0_M_AXI_AWSIZE),
        .s_axi_awuser(cache_controller_wra_0_M_AXI_AWUSER),
        .s_axi_awvalid(cache_controller_wra_0_M_AXI_AWVALID),
        .s_axi_bid(cache_controller_wra_0_M_AXI_BID),
        .s_axi_bready(cache_controller_wra_0_M_AXI_BREADY),
        .s_axi_bresp(cache_controller_wra_0_M_AXI_BRESP),
        .s_axi_buser(cache_controller_wra_0_M_AXI_BUSER),
        .s_axi_bvalid(cache_controller_wra_0_M_AXI_BVALID),
        .s_axi_rdata(cache_controller_wra_0_M_AXI_RDATA),
        .s_axi_rid(cache_controller_wra_0_M_AXI_RID),
        .s_axi_rlast(cache_controller_wra_0_M_AXI_RLAST),
        .s_axi_rready(cache_controller_wra_0_M_AXI_RREADY),
        .s_axi_rresp(cache_controller_wra_0_M_AXI_RRESP),
        .s_axi_ruser(cache_controller_wra_0_M_AXI_RUSER),
        .s_axi_rvalid(cache_controller_wra_0_M_AXI_RVALID),
        .s_axi_wdata(cache_controller_wra_0_M_AXI_WDATA),
        .s_axi_wlast(cache_controller_wra_0_M_AXI_WLAST),
        .s_axi_wready(cache_controller_wra_0_M_AXI_WREADY),
        .s_axi_wstrb(cache_controller_wra_0_M_AXI_WSTRB),
        .s_axi_wuser(cache_controller_wra_0_M_AXI_WUSER),
        .s_axi_wvalid(cache_controller_wra_0_M_AXI_WVALID));
  design_2_mig_7series_0_0 mig_7series_0
       (.aresetn(proc_sys_reset_0_peripheral_aresetn),
        .clk_ref_i(clk_wiz_0_clk_out200m),
        ...
        .sys_clk_i(clk_wiz_0_clk_out333m),
