...
# -----------------------------------------------
	.globl	udiv                             # -- Begin function udiv
	.p2align	1
	.type	udiv,@function
udiv:                                    # @udiv
# %bb.0:                                # %entry
...
# %bb.1:                                # %entry.endif
	ret
.Myfunc_end104:
	.size	udiv, .Myfunc_end104-udiv
#                                         # -- End function
# -----------------------------------------------

# -----------------------------------------------
	.globl	umul                             # -- Begin function umul
	.p2align	1
	.type	umul,@function
umul:                                    # @umul
# %bb.0:                                # %entry
...
# %bb.5:
	fmul.s	fa3, fa5, fa5
	lui	a0, %hi(.LCPI15_10)
	flw	fa2, %lo(.LCPI15_10)(a0)
	fadd.s	fa4, fa5, fa4
	lui	a0, %hi(.LCPI15_11)
	flw	fa1, %lo(.LCPI15_11)(a0)
	fmul.s	fa2, fa3, fa2
	fmul.s	fa5, fa5, fa2
	fadd.s	fa4, fa4, fa5
	fmul.s	fa2, fa3, fa1
	fmul.s	fa5, fa2, fa5
	lui	a0, %hi(.LCPI15_12)
	flw	fa2, %lo(.LCPI15_12)(a0)
	fadd.s	fa4, fa4, fa5
	lui	a0, %hi(.LCPI15_13)
	flw	fa1, %lo(.LCPI15_13)(a0)
	fmul.s	fa2, fa3, fa2
	fmul.s	fa5, fa2, fa5
	fadd.s	fa4, fa4, fa5
	fmul.s	fa3, fa3, fa1
...
.LBB15_8:
	lui	a0, %hi(.LCPI15_1)
	flw	fa4, %lo(.LCPI15_1)(a0)
	flt.s	a0, fa5, fa4
	beqz	a0, .LBB15_11
# %bb.9:
	lui	a0, %hi(.LCPI15_9)
	flw	fa4, %lo(.LCPI15_9)(a0)
	fadd.s	fa5, fa5, fa4
.LBB15_10:
	fmul.s	fa5, fa5, fa5
	lui	a0, 782336
